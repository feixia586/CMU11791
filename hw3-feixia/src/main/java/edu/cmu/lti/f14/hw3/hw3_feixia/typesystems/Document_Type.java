...
package edu.cmu.lti.f14.hw3.hw3_feixia.typesystems;
...
/** 
 * Updated by JCasGen Sun Oct 19 12:46:50 EDT 2014
 * @generated */
public class Document_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("edu.cmu.lti.f14.hw3.hw3_feixia.typesystems.Document");
  ...
  public int getRelevanceValue(int addr) {
      ...
      jcas.throwFeatMissing("relevanceValue", "edu.cmu.lti.f14.hw3.hw3_feixia.typesystems.Document");
  ...
  public int getQueryID(int addr) {
      ...
      jcas.throwFeatMissing("queryID", "edu.cmu.lti.f14.hw3.hw3_feixia.typesystems.Document");
  ...
  public String getText(int addr) {
      ...
      jcas.throwFeatMissing("text", "edu.cmu.lti.f14.hw3.hw3_feixia.typesystems.Document");
  ...
  public int getTokenList(int addr) {
      ...
      jcas.throwFeatMissing("tokenList", "edu.cmu.lti.f14.hw3.hw3_feixia.typesystems.Document");
