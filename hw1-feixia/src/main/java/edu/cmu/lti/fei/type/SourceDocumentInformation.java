...
/* First created by JCasGen Mon Sep 22 01:01:56 EDT 2014 */
...
/** 
 * Updated by JCasGen Mon Sep 22 01:03:10 EDT 2014
 * XML source: /home/fei/Projects/java_workspace/CMU11791/hw1-feixia/src/main/resources/descriptors/FileSystemCollectionReader.xml
 * @generated */
  ...
  */  
  ...
  public String getUri() {
    if (SourceDocumentInformation_Type.featOkTst && ((SourceDocumentInformation_Type)jcasType).casFeat_uri == null)
      jcasType.jcas.throwFeatMissing("uri", "edu.cmu.lti.fei.type.SourceDocumentInformation");
  ...
  public int getOffsetInSource() {
    if (SourceDocumentInformation_Type.featOkTst && ((SourceDocumentInformation_Type)jcasType).casFeat_offsetInSource == null)
      jcasType.jcas.throwFeatMissing("offsetInSource", "edu.cmu.lti.fei.type.SourceDocumentInformation");
  ...
  public int getDocumentSize() {
    if (SourceDocumentInformation_Type.featOkTst && ((SourceDocumentInformation_Type)jcasType).casFeat_documentSize == null)
      jcasType.jcas.throwFeatMissing("documentSize", "edu.cmu.lti.fei.type.SourceDocumentInformation");
  ...
  public boolean getLastSegment() {
    if (SourceDocumentInformation_Type.featOkTst && ((SourceDocumentInformation_Type)jcasType).casFeat_lastSegment == null)
      jcasType.jcas.throwFeatMissing("lastSegment", "edu.cmu.lti.fei.type.SourceDocumentInformation");
